...
| **Frontend** | React 18, Vite, JavaScript (ES6+), HTML5, CSS3, Tailwind CSS, Framer Motion |
| **Backend** | Python, Flask, Groq Cloud API, REST APIs, JWT (Auth) |
| **Bases de Datos** | PostgreSQL, SQLite, SQLAlchemy (ORM) |
| **DevOps & Tools** | Docker, Docker Compose, Nginx, Git, GitHub, Postman, Bash/PowerShell |
...
Un sistema de orquestación neural capaz de desglosar objetivos complejos en tareas técnicas detalladas.
* **Stack:** React, Flask, Groq API, Docker.
* **Key Feature:** Arquitectura de contenedores lista para producción y gestión de estados complejos en el frontend.

---

### 🎓 Formación y Crecimiento
* ⚡ **Actualmente cursando:** Full Stack Software Development en **4Geeks Academy**.
* 🔭 **Intereses:** Optimización de algoritmos, IA generativa y arquitecturas Cloud Native.
* 🌱 **Aprendizaje continuo:** Expandiendo mis conocimientos en testing automatizado y despliegue continuo (CI/CD).

---

### 📫 Conectemos
* 📧 **Email:** jorgotero4@gmail.com
* 💬 **Hablemos sobre:** Desarrollo web, integración de APIs o nuevas tecnologías.
